...
public class Pair<A, B> {
	...
	public static final class F {
		public static final <A, B> Function<A, Pair<A, B>> partialRight(final B right) {
			return left -> Pair.make(left, right);
		}

		public static final <A, B> Function<B, Pair<A, B>> partialLeft(final A left) {
			return right -> Pair.make(left, right);
		}

		public static final <A, B, R> Function<Pair<A, B>, Pair<R, B>> mapLeft(final Function<A, R> fun) {
			return pair -> pair.mapLeft(fun);
		}

		public static final <A, B, R> Function<Pair<A, B>, Pair<A, R>> mapRight(final Function<B, R> fun) {
			return pair -> pair.mapRight(fun);
		}

		public static final <A, B, R> Function<Pair<A, B>, Pair<R, B>> mapLeft(final R neoLiberal) {
			return pair -> pair.mapLeft(neoLiberal);
		}

		public static final <A, B, R> Function<Pair<A, B>, Pair<A, R>> mapRight(final R altRight) {
			return pair -> pair.mapRight(altRight);
		}

		public static final <A, B> UnaryOperator<Pair<A, B>> replaceLeft(A neoLiberal) {
			return pair -> pair.replaceLeft(neoLiberal);
		}

		public static final <A, B> UnaryOperator<Pair<A, B>> replaceRight(B altRight) {
			return pair -> pair.replaceRight(altRight);
		}

		public static final <A, B, R> Function<Pair<A, B>, R> intoFun(final BiFunction<A, B, R> fun) {
			return pair -> pair.intoFun(fun);
		}

		public static final <A, B> UnaryOperator<Pair<A, B>> intoPair(final UnaryOperator<Pair<A, B>> fun) {
			return pair -> pair.intoFun(fun);
		}

		public static final <A, B> ToDoubleFunction<Pair<A, B>> intoDouble(final ToDoubleFunction<Pair<A, B>> fun) {
			return pair -> pair.intoDouble(fun);
		}

		public static final <A, B> ToDoubleFunction<Pair<A, B>> intoDouble(final ToDoubleBiFunction<A, B> fun) {
			return pair -> pair.intoDouble(fun);
		}

		public static final <A, B> Consumer<Pair<A, B>> intoCon(final BiConsumer<A, B> fun) {
			return pair -> pair.intoCon(fun);
		}

		public static final <A, B> Predicate<Pair<A, B>> intoPred(final BiPredicate<A, B> pred) {
			return pair -> pair.intoPred(pred);
		}

		public static final <A, B> Predicate<Pair<A, B>> predLeft(final Predicate<A> pred) {
			return pair -> pair.predLeft(pred);
		}

		public static final <A, B> Predicate<Pair<A, B>> predRight(final Predicate<B> pred) {
